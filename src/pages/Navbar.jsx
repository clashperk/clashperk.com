		...
		return (
			<Navbar collapseOnSelect variant="light" expand="lg" fixed="top" style={{ background }}>
				...
				<Navbar.Collapse id="basic-navbar-nav">
					...
					{/* Right Side Menu */}
					<Nav>
						<Nav.Link style={{ color }} href="#" onClick={this.scrollTo} hidden={this.props.hide}>FEATURES</Nav.Link>
						<Nav.Link as={Link} to="/guide" style={{ color }}>GUIDE</Nav.Link>
						<Nav.Link as={Link} to="/faq" style={{ color }}>FAQ</Nav.Link>
